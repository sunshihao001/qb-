...
| 字段 | 数值 |
|---|---|
| Position ID | paper-9KrdYnHHrsWYpWMxyzbmmrjcXRr7ERWpB3byNeb1pump-2026-05-02T13:54:47Z |
| Token | UNIPUMP |
...
纸面仓位在 2026-05-02T17:22:43Z 退出，退出价 0.00031130712693739325，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 WIN，收益 42.13%。盈利交易不自动写 failure_type；需要继续判断收益是否来自策略证据链，还是右尾偶然。
