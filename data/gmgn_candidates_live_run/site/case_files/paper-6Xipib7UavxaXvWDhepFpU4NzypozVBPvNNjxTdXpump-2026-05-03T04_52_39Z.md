...
| 字段 | 数值 |
|---|---|
| Position ID | paper-6Xipib7UavxaXvWDhepFpU4NzypozVBPvNNjxTdXpump-2026-05-03T04:52:39Z |
| Token | MILF |
...
纸面仓位在 2026-04-29 18:55:00 UTC 入场。入场模式 live，原始报价 6.725796880906488e-05，模拟入场价 6.725796880906488e-05，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.142401 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-03T04:57:03Z 退出，退出价 5.9903868260630676e-05，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 LOSS，收益 -10.93%。需要重点复查入场是否追高、钱包结构是否误判、quote/security 是否延迟，以及退出是否过慢。
