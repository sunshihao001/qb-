...
| 字段 | 数值 |
|---|---|
| Position ID | paper-F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump-2026-05-02T17:54:54Z |
| Token | lolcat |
...
纸面仓位在 2026-05-01 14:52:00 UTC 入场。入场模式 live，原始报价 7.285195811222505e-05，模拟入场价 7.285195811222505e-05，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.150147 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-02T18:05:49Z 退出，退出价 7.509463249687695e-05，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 WIN，收益 3.078%。盈利交易不自动写 failure_type；需要继续判断收益是否来自策略证据链，还是右尾偶然。
