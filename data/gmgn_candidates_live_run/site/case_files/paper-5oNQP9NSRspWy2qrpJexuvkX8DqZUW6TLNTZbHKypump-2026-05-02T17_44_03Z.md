...
| 字段 | 数值 |
|---|---|
| Position ID | paper-5oNQP9NSRspWy2qrpJexuvkX8DqZUW6TLNTZbHKypump-2026-05-02T17:44:03Z |
| Token | CHARITYDROP |
| Address | 5oNQP9NSRspWy2qrpJexuvkX8DqZUW6TLNTZbHKypump |
| 状态 | CLOSED |
| 策略 | SIKK-B 控盘箱体突破回踩 |
| 信号等级 | S4_强确认信号 |
| 入场时间 | 2026-05-01 01:34:00 UTC |
| 退出时间 | 2026-05-02T17:54:54Z |
| 纸面仓位 | 0.2 SOL |
| 入场市值 | 待补 |
| 退出市值 | 待补 |
| 净收益 | -2.8173 |
...
系统在 待补 发现 CHARITYDROP。发现时市值 待补，流动性 待补，持有人 待补。纳入观察原因：进入 GMGN/SIKK 候选观察池，等待盘型、信号和钱包结构进一步确认。
...
信号在 待补 触发，等级为 S4_强确认信号，类型为 SIKK-B 控盘箱体突破回踩。信号价 4.2863783e-05，信号时市值 待补。失效条件：跌破关键结构位或钱包结构转弱。
...
钱包结构在 待补 给出 WALLET_BLOCK。结构分 0.0，风险分 100.0，对手盘压力 100.0，数据质量 100。钱包解释：早期钱包集中清仓，筹码控制权疑似向分发/对手盘转移；发现分发侧钱包 9 个；对手盘压力高，接盘/套牢筹码占比偏高。钱包结构在这里是纸面验证门禁，不是实盘买入授权。
...
纸面仓位在 2026-05-01 01:34:00 UTC 入场。入场模式 live，原始报价 5.912092422459751e-05，模拟入场价 5.912092422459751e-05，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.2 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-02T17:54:54Z 退出，退出价 5.745529663499124e-05，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 LOSS，收益 -2.817%。需要重点复查入场是否追高、钱包结构是否误判、quote/security 是否延迟，以及退出是否过慢。
...
| data_quality_score | data/gmgn_candidates_live_run/wallet_structure/5oNQP9NSRspWy2qrpJexuvkX8DqZUW6TLNTZbHKypump/wallet_structure_decision.json |
