...
| 字段 | 数值 |
|---|---|
| Position ID | paper-C1FjBybKVyatJcJ8JDd7VunSjVkmsb3m1p6q3qvHpump-2026-05-02T03:19:42Z |
| Token | 1000x |
| Address | C1FjBybKVyatJcJ8JDd7VunSjVkmsb3m1p6q3qvHpump |
| 状态 | CLOSED |
| 策略 | SIKK-B 控盘箱体突破回踩 |
| 信号等级 | S4_强确认信号 |
| 入场时间 | 2026-04-28 23:11:00 UTC |
| 退出时间 | 2026-05-02T12:20:12Z |
| 纸面仓位 | 0.060928 SOL |
| 入场市值 | 待补 |
| 退出市值 | 待补 |
| 净收益 | -4.3929 |
...
系统在 待补 发现 1000x。发现时市值 待补，流动性 待补，持有人 待补。纳入观察原因：进入 GMGN/SIKK 候选观察池，等待盘型、信号和钱包结构进一步确认。
...
| wallet_structure_score | 16 |
| wallet_risk_score | 100 |
| counterparty_pressure_score | 100 |
| data_quality_score | 100 |

钱包结构在 待补 给出 WALLET_BLOCK。结构分 16，风险分 100，对手盘压力 100，数据质量 100。钱包解释：发现分发侧钱包 10 个；对手盘压力高，接盘/套牢筹码占比偏高。钱包结构在这里是纸面验证门禁，不是实盘买入授权。
...
纸面仓位在 2026-04-28 23:11:00 UTC 入场。入场模式 待补，原始报价 待补，模拟入场价 0.00017055563，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.060928 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-02T12:20:12Z 退出，退出价 0.00016306336238448458，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 LOSS，收益 -4.393%。需要重点复查入场是否追高、钱包结构是否误判、quote/security 是否延迟，以及退出是否过慢。
...
| 字段 | 来源文件 |
|---|---|
| counterparty_pressure_score | data/gmgn_candidates_live_run/wallet_structure/C1FjBybKVyatJcJ8JDd7VunSjVkmsb3m1p6q3qvHpump/wallet_structure_decision.json |
| current_price | paper_position_json |
| data_quality_score | data/gmgn_candidates_live_run/wallet_structure/C1FjBybKVyatJcJ8JDd7VunSjVkmsb3m1p6q3qvHpump/wallet_structure_decision.json |
...
| wallet_risk_score | data/gmgn_candidates_live_run/wallet_structure/C1FjBybKVyatJcJ8JDd7VunSjVkmsb3m1p6q3qvHpump/wallet_structure_decision.json |
| wallet_structure_reason | data/gmgn_candidates_live_run/wallet_structure/C1FjBybKVyatJcJ8JDd7VunSjVkmsb3m1p6q3qvHpump/wallet_structure_decision.json |
| wallet_structure_score | data/gmgn_candidates_live_run/wallet_structure/C1FjBybKVyatJcJ8JDd7VunSjVkmsb3m1p6q3qvHpump/wallet_structure_decision.json |
| wallet_structure_status | data/gmgn_candidates_live_run/wallet_structure/C1FjBybKVyatJcJ8JDd7VunSjVkmsb3m1p6q3qvHpump/wallet_structure_decision.json |
