...
| 字段 | 数值 |
|---|---|
| Position ID | paper-3XwDQHMKcner1GhXRqLKojrWWwNdMaruQs7g7riDpump-2026-05-04T01:23:21Z |
| Token | Trollpface |
| Address | 3XwDQHMKcner1GhXRqLKojrWWwNdMaruQs7g7riDpump |
| 状态 | CLOSED |
| 策略 | SIKK-B 控盘箱体突破回踩 |
| 信号等级 | S4_强确认信号 |
| 入场时间 | 2026-05-04T01:23:21Z |
| 退出时间 | 2026-05-04T04:52:01Z |
| 纸面仓位 | 0.2 SOL |
| 入场市值 | 待补 |
| 退出市值 | 待补 |
| 净收益 | -72.0134 |
...
系统在 待补 发现 Trollpface。发现时市值 待补，流动性 待补，持有人 待补。纳入观察原因：进入 GMGN/SIKK 候选观察池，等待盘型、信号和钱包结构进一步确认。
...
信号在 2026-05-03 15:16:00 UTC 触发，等级为 S4_强确认信号，类型为 SIKK-B 控盘箱体突破回踩。信号价 0.00041673111，信号时市值 待补。失效条件：跌破关键结构位或钱包结构转弱。
...
| counterparty_pressure_score | 24.0 |
| data_quality_score | 100.0 |

钱包结构在 2026-05-04T01:23:21Z 给出 WALLET_BLOCK。结构分 0.0，风险分 100.0，对手盘压力 24.0，数据质量 100.0。钱包解释：发现分发侧钱包 2 个；缺失字段：wallet_address, role, game_side, evidence_level；筹码控制状态机：CONTROL_BREAK_OR_DISTRIBUTION；筹码控制状态机：WALLET_BLOCK；筹码控制状态机：DISTRIBUTION_ACTIVE。钱包结构在这里是纸面验证门禁，不是实盘买入授权。
...
| 入场上下文 | UNKNOWN_ENTRY |
| 买入规模 | 0.2 SOL |
| 估算 token 数量 | 160.17245354 |

纸面仓位在 2026-05-04T01:23:21Z 入场。入场模式 live，原始报价 0.0012486541573164711，模拟入场价 0.0012486541573164711，滑点 3.0%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.2 SOL，约 0 USD，估算 token 数量 160.17245354。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
持仓过程已记录 4 条 journal。最近一次 2026-05-04T04:21:53Z，价格 0.0005651808577935046，浮动收益 -54.74%，动作 EXIT_MONITOR，原因 钱包结构出现风险，但 多轮 delta 未确认；盘型冲突未确认；市场确认不足，默认 EXIT_MONITOR。

| 时间 | 价格 | 市值 | 浮盈 | 钱包状态 | 动作 | 原因 |
|---|---:|---:|---:|---|---|---|
| 2026-05-04T01:23:21Z | 0.0012486541573164711 | 待补 | 0.0 | WALLET_BLOCK | PAPER_ENTRY | 新纸面仓位入场后记录首条持仓日志 |
| 2026-05-04T03:43:35Z | 0.0011385012083406077 | 待补 | -8.8217 | WALLET_BLOCK | EXIT_MONITOR | 钱包结构出现风险，但 多轮 delta 未确认；盘型冲突未确认；市场确认不足，默认 EXIT_MONITOR |
| 2026-05-04T04:13:57Z | 0.0005869097735015521 | 待补 | -52.9966 | WALLET_BLOCK | EXIT_MONITOR | 钱包结构出现风险，但 多轮 delta 未确认；盘型冲突未确认；市场确认不足，默认 EXIT_MONITOR |
| 2026-05-04T04:21:53Z | 0.0005651808577935046 | 待补 | -54.7368 | WALLET_BLOCK | EXIT_MONITOR | 钱包结构出现风险，但 多轮 delta 未确认；盘型冲突未确认；市场确认不足，默认 EXIT_MONITOR |

---

## 10. 退出

纸面仓位在 2026-05-04T04:52:01Z 退出，退出价 0.00034945560065248764，退出市值 待补。退出触发 待补，原因码 待补，原因：命中纸面止损。
...
本次结果为 LOSS，收益 -72.01%。需要重点复查入场是否追高、钱包结构是否误判、quote/security 是否延迟，以及退出是否过慢。
...
| security_risk_level | data/gmgn_candidates_live_run/wallet_structure/3XwDQHMKcner1GhXRqLKojrWWwNdMaruQs7g7riDpump/wallet_structure_decision.json |
