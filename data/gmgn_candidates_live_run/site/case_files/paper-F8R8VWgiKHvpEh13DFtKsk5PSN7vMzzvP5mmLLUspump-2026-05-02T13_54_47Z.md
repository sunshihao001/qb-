...
| 字段 | 数值 |
|---|---|
| Position ID | paper-F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump-2026-05-02T13:54:47Z |
| Token | lolcat |
...
钱包结构在 待补 给出 WALLET_BLOCK。结构分 48.0，风险分 100.0，对手盘压力 100.0，数据质量 100。钱包解释：发现分发侧钱包 8 个；对手盘压力高，接盘/套牢筹码占比偏高。钱包结构在这里是纸面验证门禁，不是实盘买入授权。
...
纸面仓位在 2026-05-02T17:22:43Z 退出，退出价 9.022412796068749e-05，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 BIG_WIN，收益 160.8%。盈利交易不自动写 failure_type；需要继续判断收益是否来自策略证据链，还是右尾偶然。
