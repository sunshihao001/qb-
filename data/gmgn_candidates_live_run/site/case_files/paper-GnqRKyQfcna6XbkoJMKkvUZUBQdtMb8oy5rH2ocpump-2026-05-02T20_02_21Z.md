...
| 字段 | 数值 |
|---|---|
| Position ID | paper-GnqRKyQfcna6XbkoJMKkvUZUBQdtMb8oy5rH2ocpump-2026-05-02T20:02:21Z |
| Token | MSTRUMP |
...
纸面仓位在 2026-05-02 18:08:00 UTC 入场。入场模式 live，原始报价 0.00020530531743003072，模拟入场价 0.00020530531743003072，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.123829 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-02T20:12:49Z 退出，退出价 0.00021617994705252136，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 WIN，收益 5.297%。盈利交易不自动写 failure_type；需要继续判断收益是否来自策略证据链，还是右尾偶然。
