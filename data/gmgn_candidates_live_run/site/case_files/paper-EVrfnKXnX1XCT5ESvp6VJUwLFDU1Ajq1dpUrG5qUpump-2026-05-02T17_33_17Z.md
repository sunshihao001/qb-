...
| 字段 | 数值 |
|---|---|
| Position ID | paper-EVrfnKXnX1XCT5ESvp6VJUwLFDU1Ajq1dpUrG5qUpump-2026-05-02T17:33:17Z |
| Token | SMW |
...
钱包结构在 待补 给出 WALLET_BLOCK。结构分 32.0，风险分 100.0，对手盘压力 100.0，数据质量 100。钱包解释：发现分发侧钱包 1 个；对手盘压力高，接盘/套牢筹码占比偏高。钱包结构在这里是纸面验证门禁，不是实盘买入授权。
...
纸面仓位在 2026-05-02 16:13:00 UTC 入场。入场模式 live，原始报价 0.00019030106591539405，模拟入场价 0.00019030106591539405，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.2 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-02T17:33:17Z 退出，退出价 0.00019030106591539405，退出市值 待补。退出触发 待补，原因码 待补，原因：命中纸面止损。
