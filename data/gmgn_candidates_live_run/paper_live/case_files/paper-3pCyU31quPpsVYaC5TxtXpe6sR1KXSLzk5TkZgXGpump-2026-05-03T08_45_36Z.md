...
| 字段 | 数值 |
|---|---|
| Position ID | paper-3pCyU31quPpsVYaC5TxtXpe6sR1KXSLzk5TkZgXGpump-2026-05-03T08:45:36Z |
| Token | GOP |
...
纸面仓位在 2026-04-28 03:41:00 UTC 入场。入场模式 live，原始报价 0.00047276693662327276，模拟入场价 0.00047276693662327276，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.040857 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-03T08:56:03Z 退出，退出价 0.0004973414146106894，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 WIN，收益 5.198%。盈利交易不自动写 failure_type；需要继续判断收益是否来自策略证据链，还是右尾偶然。
