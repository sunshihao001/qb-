...
| 字段 | 数值 |
|---|---|
| Position ID | paper-F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump-2026-05-02T03:19:42Z |
| Token | lolcat |
| Address | F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump |
| 状态 | CLOSED |
| 策略 | SIKK-B 控盘箱体突破回踩 |
| 信号等级 | S4_强确认信号 |
| 入场时间 | 2026-05-01 14:52:00 UTC |
...
系统在 待补 发现 lolcat。发现时市值 待补，流动性 待补，持有人 待补。纳入观察原因：进入 GMGN/SIKK 候选观察池，等待盘型、信号和钱包结构进一步确认。
...
| wallet_structure_score | 32 |
| wallet_risk_score | 100 |
| counterparty_pressure_score | 100 |
| data_quality_score | 100 |

钱包结构在 待补 给出 WALLET_BLOCK。结构分 32，风险分 100，对手盘压力 100，数据质量 100。钱包解释：发现分发侧钱包 8 个；对手盘压力高，接盘/套牢筹码占比偏高。钱包结构在这里是纸面验证门禁，不是实盘买入授权。
...
纸面仓位在 2026-05-01 14:52:00 UTC 入场。入场模式 待补，原始报价 待补，模拟入场价 3.4589665e-05，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.150147 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-02T06:57:00Z 退出，退出价 0.00015326031261579282，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 BIG_WIN，收益 343.1%。盈利交易不自动写 failure_type；需要继续判断收益是否来自策略证据链，还是右尾偶然。
...
| 字段 | 来源文件 |
|---|---|
| counterparty_pressure_score | data/gmgn_candidates_live_run/wallet_structure/F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump/wallet_structure_decision.json |
| current_price | paper_position_json |
| data_quality_score | data/gmgn_candidates_live_run/wallet_structure/F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump/wallet_structure_decision.json |
...
| wallet_risk_score | data/gmgn_candidates_live_run/wallet_structure/F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump/wallet_structure_decision.json |
| wallet_structure_reason | data/gmgn_candidates_live_run/wallet_structure/F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump/wallet_structure_decision.json |
| wallet_structure_score | data/gmgn_candidates_live_run/wallet_structure/F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump/wallet_structure_decision.json |
| wallet_structure_status | data/gmgn_candidates_live_run/wallet_structure/F8R8VWgiKHvpEh13DFtKsk5PSN7vMzzvP5mmLLUspump/wallet_structure_decision.json |
