...
| 字段 | 数值 |
|---|---|
| Position ID | paper-Hx2CNHde124aDvhyviusCAkp9nnEYEwfefghHRqgpump-2026-05-03T11:14:23Z |
| Token | Gigadowns |
| Address | Hx2CNHde124aDvhyviusCAkp9nnEYEwfefghHRqgpump |
| 状态 | CLOSED |
| 策略 | SIKK-B 控盘箱体突破回踩 |
| 信号等级 | S4_强确认信号 |
| 入场时间 | 2026-05-03T11:14:23Z |
| 退出时间 | 2026-05-04T01:23:21Z |
| 纸面仓位 | 0.071587 SOL |
| 入场市值 | 待补 |
| 退出市值 | 待补 |
| 净收益 | -91.1099 |
...
系统在 待补 发现 Gigadowns。发现时市值 待补，流动性 待补，持有人 待补。纳入观察原因：进入 GMGN/SIKK 候选观察池，等待盘型、信号和钱包结构进一步确认。
...
信号在 2026-05-03 10:26:00 UTC 触发，等级为 S4_强确认信号，类型为 SIKK-B 控盘箱体突破回踩。信号价 6.4925116e-05，信号时市值 待补。失效条件：跌破关键结构位或钱包结构转弱。
...
钱包结构在 2026-05-03T11:14:23Z 给出 WALLET_BLOCK。结构分 0.0，风险分 100.0，对手盘压力 100.0，数据质量 100.0。钱包解释：发现分发侧钱包 4 个；对手盘压力高，接盘/套牢筹码占比偏高；缺失字段：wallet_address, role, game_side, evidence_level；筹码控制状态机：CONTROL_BREAK_OR_DISTRIBUTION；筹码控制状态机：WALLET_BLOCK；筹码控制状态机：DISTRIBUTION_ACTIVE。钱包结构在这里是纸面验证门禁，不是实盘买入授权。
...
| 入场上下文 | UNKNOWN_ENTRY |
| 买入规模 | 0.071587 SOL |
| 估算 token 数量 | 1336.02820293 |

纸面仓位在 2026-05-03T11:14:23Z 入场。入场模式 live，原始报价 5.358195271868577e-05，模拟入场价 5.358195271868577e-05，滑点 3.0%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.071587 SOL，约 0 USD，估算 token 数量 1336.02820293。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
持仓过程已记录 3 条 journal。最近一次 2026-05-03T12:38:10Z，价格 4.399794359862647e-05，浮动收益 -17.89%，动作 EXIT_MONITOR，原因 钱包结构出现风险，但 多轮 delta 未确认；盘型冲突未确认；市场确认不足，默认 EXIT_MONITOR。

| 时间 | 价格 | 市值 | 浮盈 | 钱包状态 | 动作 | 原因 |
|---|---:|---:|---:|---|---|---|
| 2026-05-03T11:14:23Z | 5.358195271868577e-05 | 待补 | 0.0 | WALLET_BLOCK | PAPER_ENTRY | 新纸面仓位入场后记录首条持仓日志 |
| 2026-05-03T12:36:55Z | 4.704899238964845e-05 | 待补 | -12.1925 | WALLET_BLOCK | EXIT_MONITOR | 钱包结构出现风险，但 多轮 delta 未确认；盘型冲突未确认；市场确认不足，默认 EXIT_MONITOR |
| 2026-05-03T12:38:10Z | 4.399794359862647e-05 | 待补 | -17.8866 | WALLET_BLOCK | EXIT_MONITOR | 钱包结构出现风险，但 多轮 delta 未确认；盘型冲突未确认；市场确认不足，默认 EXIT_MONITOR |

---

## 10. 退出

纸面仓位在 2026-05-04T01:23:21Z 退出，退出价 4.763464041332018e-06，退出市值 待补。退出触发 待补，原因码 待补，原因：命中纸面止损。
...
本次结果为 LOSS，收益 -91.11%。需要重点复查入场是否追高、钱包结构是否误判、quote/security 是否延迟，以及退出是否过慢。
...
| security_risk_level | data/gmgn_candidates_live_run/wallet_structure/Hx2CNHde124aDvhyviusCAkp9nnEYEwfefghHRqgpump/wallet_structure_decision.json |
