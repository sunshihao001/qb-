...
| 字段 | 数值 |
|---|---|
| Position ID | paper-GnqRKyQfcna6XbkoJMKkvUZUBQdtMb8oy5rH2ocpump-2026-05-02T19:09:45Z |
| Token | MSTRUMP |
| Address | GnqRKyQfcna6XbkoJMKkvUZUBQdtMb8oy5rH2ocpump |
| 状态 | CLOSED |
| 策略 | SIKK-B 控盘箱体突破回踩 |
| 信号等级 | S4_强确认信号 |
| 入场时间 | 2026-05-02 18:10:00 UTC |
| 退出时间 | 2026-05-02T19:20:16Z |
| 纸面仓位 | 0.2 SOL |
| 入场市值 | 待补 |
| 退出市值 | 待补 |
| 净收益 | -18.4467 |
...
信号在 待补 触发，等级为 S4_强确认信号，类型为 SIKK-B 控盘箱体突破回踩。信号价 0.00020833754，信号时市值 待补。失效条件：跌破关键结构位或钱包结构转弱。
...
纸面仓位在 2026-05-02 18:10:00 UTC 入场。入场模式 live，原始报价 0.00023855734979980707，模拟入场价 0.00023855734979980707，滑点 待补%。入场时市值 待补，相对发现时市值变化 待补，上下文为 UNKNOWN_ENTRY。本次纸面规模 0.2 SOL，约 待补，估算 token 数量 待补。入场依据：盘型、信号、钱包结构和 quote/security 同时满足纸面验证条件。
...
纸面仓位在 2026-05-02T19:20:16Z 退出，退出价 0.00019455133389511986，退出市值 待补。退出触发 待补，原因码 STRUCTURE_WEAKENING，原因：钱包结构触发纸面强制退出。
...
本次结果为 LOSS，收益 -18.45%。需要重点复查入场是否追高、钱包结构是否误判、quote/security 是否延迟，以及退出是否过慢。
