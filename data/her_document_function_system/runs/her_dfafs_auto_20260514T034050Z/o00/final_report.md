...
## 1. Run Info
- run_id: her_dfafs_auto_20260514T034050Z
- document: o00_sample_document.md
- operator_goal: {'goal_id': 'o00_sample_goal', 'goal': 'verify O00 safe-mode run-document produces READY_WITH_GAPS evidence without false claims'}
- safe_mode: true
