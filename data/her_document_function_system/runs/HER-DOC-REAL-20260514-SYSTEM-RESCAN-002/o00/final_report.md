...
## 1. Run Info
- run_id: HER-DOC-REAL-20260514-SYSTEM-RESCAN-002
- document: doc_760ab53e405f_交易系统体系再摄取与落地审计方案 (1).md
- operator_goal: SIKK Full System Rescan：基于 Knowledge Processing Program 的交易系统全量再摄取与落地审计；只做扫描、映射、审计、候选任务包生成；safe-mode；禁止真实交易、签名、broadcast、auto deploy。
- safe_mode: true
