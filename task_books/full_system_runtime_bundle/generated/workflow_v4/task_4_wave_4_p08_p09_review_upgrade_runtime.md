...
## 目标
运行 P08-P09 复盘学习与系统升级建议包；只产生 review-only upgrade package。

## 边界
P09 不自动改交易策略或上线能力，只生成审计后的升级候选。
...
## handoff
- READY：进入 `task_5_full_system_e2e_validation`
