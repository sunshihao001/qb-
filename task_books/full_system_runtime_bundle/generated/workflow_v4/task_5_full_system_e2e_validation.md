...
## 目标
验证 P01-P09 handoff、状态继承、missing 传播、hard-negative 继承、审计链完整性。

## 边界
E2E 通过不等同 live-ready，不授权真实资金动作。
...
## handoff
- READY：进入 `FULL_SYSTEM_WORKFLOW_V4_READY_OR_READY_WITH_GAPS`
