...
## 目标
运行 P04-P05 场景识别与结构位置代码落地、测试、replay 与 handoff。

## 边界
继承 Wave1 handoff；禁止用缺失字段推断确定结论。
...
## handoff
- READY：进入 `task_3_wave_3_p06_p07_strategy_execution_risk_runtime`
