# Wave 01 P01-P03 Foundation Runtime
...
## Wave 目标
P01 phase_01_data_fact → P02 phase_02_wallet_structure → P03 phase_03_chip_control
...
## 状态码
WAVE_01_RUNTIME_READY | WAVE_01_RUNTIME_READY_WITH_GAPS | WAVE_01_RUNTIME_REJECTED

## 下一步
通过后解锁 Wave 2；失败进入 Patch + Regression。
