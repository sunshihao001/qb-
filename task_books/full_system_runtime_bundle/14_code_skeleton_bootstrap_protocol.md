# 14 Code Skeleton Bootstrap Protocol
...
## Wave 执行时检查
每阶段检查 contracts/phase_xx、schemas/phase_xx、src/phase_xx、tests/phase_xx、tests/fixtures/phase_xx。

## 缺失处理
根据 pXX_code_landing.md 创建代码骨架，随后运行 pXX_acceptance_check、pytest、replay、handoff、shared_handoff、audit。

## Task0 边界
Task0 只建立规则，不创建业务代码骨架。
