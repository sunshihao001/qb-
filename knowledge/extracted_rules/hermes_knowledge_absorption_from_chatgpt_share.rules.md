# hermes_knowledge_absorption_from_chatgpt_share｜可执行规则

## 规则 1
- 规则名称：原文先归档再吸收
- 原文依据：/root/sikk-gmgn/knowledge/passports/hermes_knowledge_absorption_from_chatgpt_share.passport.md
