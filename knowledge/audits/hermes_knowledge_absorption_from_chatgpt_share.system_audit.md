# hermes_knowledge_absorption_from_chatgpt_share｜系统差异审计
...
## 输入规则文件
`/root/sikk-gmgn/knowledge/extracted_rules/hermes_knowledge_absorption_from_chatgpt_share.rules.md`
