# P00 系统边界与宪法层 Execution Protocol
...
5. Invoke only registered Atomic Skills: `forbidden_action_boundary_skill, system_goal_check_skill, hard_negative_filter_skill`.
