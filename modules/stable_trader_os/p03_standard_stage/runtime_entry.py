"""Business-bound paper-only runtime entry for P03 standard stage.
...
PREVIOUS_HANDOFF = "P02_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P04']
DOWNSTREAM_INPUT_CONTRACT = 'P04_STANDARD_STAGE_INPUT'
