"""Business-bound paper-only runtime entry for K08 standard stage.
...
PREVIOUS_HANDOFF = "K07_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P00']
DOWNSTREAM_INPUT_CONTRACT = 'P00_STANDARD_STAGE_INPUT'
