"""Business-bound paper-only runtime entry for P02 standard stage.
...
PREVIOUS_HANDOFF = "P01_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P03']
DOWNSTREAM_INPUT_CONTRACT = 'P03_STANDARD_STAGE_INPUT'
