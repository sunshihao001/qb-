"""Business-bound paper-only runtime entry for K06 standard stage.
...
PREVIOUS_HANDOFF = "K05_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['K07']
DOWNSTREAM_INPUT_CONTRACT = 'K07_STANDARD_STAGE_INPUT'
