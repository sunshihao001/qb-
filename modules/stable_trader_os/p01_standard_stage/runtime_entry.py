"""Business-bound paper-only runtime entry for P01 standard stage.
...
PREVIOUS_HANDOFF = "P00_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P02']
DOWNSTREAM_INPUT_CONTRACT = 'P02_STANDARD_STAGE_INPUT'
