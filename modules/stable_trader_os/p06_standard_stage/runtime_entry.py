"""Business-bound paper-only runtime entry for P06 standard stage.
...
PREVIOUS_HANDOFF = "P05_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P07']
DOWNSTREAM_INPUT_CONTRACT = 'P07_STANDARD_STAGE_INPUT'
