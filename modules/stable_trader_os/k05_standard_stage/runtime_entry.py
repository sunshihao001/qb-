"""Business-bound paper-only runtime entry for K05 standard stage.
...
PREVIOUS_HANDOFF = "K04_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['K06']
DOWNSTREAM_INPUT_CONTRACT = 'K06_STANDARD_STAGE_INPUT'
