"""Business-bound paper-only runtime entry for I05 standard stage.
...
PREVIOUS_HANDOFF = "I04_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['R00']
DOWNSTREAM_INPUT_CONTRACT = 'R00_STANDARD_STAGE_INPUT'
