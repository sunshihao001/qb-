"""Business-bound paper-only runtime entry for K07 standard stage.
...
PREVIOUS_HANDOFF = "K06_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['K08']
DOWNSTREAM_INPUT_CONTRACT = 'K08_STANDARD_STAGE_INPUT'
