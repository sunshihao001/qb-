"""Business-bound paper-only runtime entry for P07 standard stage.
...
PREVIOUS_HANDOFF = "P06_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P08']
DOWNSTREAM_INPUT_CONTRACT = 'P08_STANDARD_STAGE_INPUT'
