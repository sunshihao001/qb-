"""Business-bound paper-only runtime entry for I01 standard stage.
...
PREVIOUS_HANDOFF = "P10_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['I02']
DOWNSTREAM_INPUT_CONTRACT = 'I02_STANDARD_STAGE_INPUT'
