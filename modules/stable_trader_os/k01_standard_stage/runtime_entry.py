"""Business-bound paper-only runtime entry for K01 standard stage.
...
PREVIOUS_HANDOFF = "K00_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['K02']
DOWNSTREAM_INPUT_CONTRACT = 'K02_STANDARD_STAGE_INPUT'
