"""Business-bound paper-only runtime entry for P10 standard stage.
...
PREVIOUS_HANDOFF = "P09_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['I01']
DOWNSTREAM_INPUT_CONTRACT = 'I01_STANDARD_STAGE_INPUT'
