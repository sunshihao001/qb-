"""Business-bound paper-only runtime entry for P05 standard stage.
...
PREVIOUS_HANDOFF = "P04_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P06']
DOWNSTREAM_INPUT_CONTRACT = 'P06_STANDARD_STAGE_INPUT'
