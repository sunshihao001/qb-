"""Business-bound paper-only runtime entry for P04 standard stage.
...
PREVIOUS_HANDOFF = "P03_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P05']
DOWNSTREAM_INPUT_CONTRACT = 'P05_STANDARD_STAGE_INPUT'
