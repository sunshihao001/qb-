"""Business-bound paper-only runtime entry for K02 standard stage.
...
PREVIOUS_HANDOFF = "K01_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['K03']
DOWNSTREAM_INPUT_CONTRACT = 'K03_STANDARD_STAGE_INPUT'
