"""Business-bound paper-only runtime entry for K03 standard stage.
...
PREVIOUS_HANDOFF = "K02_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['K04']
DOWNSTREAM_INPUT_CONTRACT = 'K04_STANDARD_STAGE_INPUT'
