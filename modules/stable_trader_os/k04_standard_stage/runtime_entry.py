"""Business-bound paper-only runtime entry for K04 standard stage.
...
PREVIOUS_HANDOFF = "K03_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['K05']
DOWNSTREAM_INPUT_CONTRACT = 'K05_STANDARD_STAGE_INPUT'
