"""Business-bound paper-only runtime entry for P09 standard stage.
...
PREVIOUS_HANDOFF = "P08_STANDARD_STAGE_HANDOFF"
NEXT_PHASE_REFS = ['P10']
DOWNSTREAM_INPUT_CONTRACT = 'P10_STANDARD_STAGE_INPUT'
