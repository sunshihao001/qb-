...
## 本节目标
P2：沉淀 Planner / Generator / Evaluator 分离、阶段合同、失败项记录与独立验收模板。

## 主题标识
`harness_superpowers_audit`

## 需要读取的文件
- `docs/imported/chatgpt_share_69f809c6_section_index.md`
- `SIKK_SYSTEM_INDEX.md`

## 允许新增/更新的输出文件
- `reports/chatgpt_share_69f809c6/PHASE_CONTRACT.md`
- `reports/chatgpt_share_69f809c6/PHASE_HANDOFF.md`
- `reports/chatgpt_share_69f809c6/FAILED_ITEMS.md`
