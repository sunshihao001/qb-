...
## 本节目标
P1：检查 case file 的 field_sources、missing_fields、quality、strategy_review_eligible 是否真实生成并进入 dashboard。

## 主题标识
`case_file_data_completeness`
...
## 允许新增/更新的输出文件
- `reports/chatgpt_share_69f809c6/S05_case_file_completeness_audit.md`
