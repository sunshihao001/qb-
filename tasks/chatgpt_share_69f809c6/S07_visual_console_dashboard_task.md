...
## 本节目标
P1：真实检查 token detail、Paper Lab、Case File、Review Lab、System Health 与待补字段。

## 主题标识
`visual_console_dashboard`
...
## 允许新增/更新的输出文件
- `reports/chatgpt_share_69f809c6/S07_visual_console_acceptance.md`
